...
let link = 'https://chat.whatsapp.com/' + await conn.groupInviteCode(group)
      ...
      await conn.reply(text+'@s.whatsapp.net', `Hola! me presento, soy Mateo Bot 🐈 y soy un Bot para WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te agregues, te esperamos!!\n\n${link}`, m, {mentions: [m.sender]})
